    ...
    return (
        <div>
            <div className=" flex justify-between mx-20 pt-20">
                {/* column 1 */}
                <div>
                    <span className=" text-[36px] font-bold text-white">get<span className=" text-pinnk">linked</span></span>
                    <div className=" text-white text-[12px] font-normal mt-2">
                        Getlinked Tech Hackathon is a technology
                        innovation program <br /> established by a group
                        of organizations with the aim of showcasing <br />
                        young and talented individuals in the field
                        of technology
                    </div>
                    <div className=" mt-20">
                        <span className=" text-white text-[12px] font-normal">Terms of Use <span className=" border-r-2 border-pinnk px-1  mr-2"></span>Privacy Policy</span>
                    </div>
                </div>

                {/* column 2 */}
                <div className=" w-[200px]">
                    <div className=" text-pinnk text-[14px] font-semibold pt-5">Useful Links</div>
                    <div className=" text-white text-[12px] font-normal mt-3 cursor-pointer">Overview</div>
                    <div className=" text-white text-[12px] font-normal mt-3 cursor-pointer">Timeline</div>
                    <div className=" text-white text-[12px] font-normal mt-3 cursor-pointer">FAQs</div>
                    <div className=" text-white text-[12px] font-normal mt-3 cursor-pointer">Register</div>

                    <div className=" flex mt-10">
                        <span className=" text-pinnk text-[12px] font-normal mr-4 pt-2">Follow us</span>
                        <div className=" flex w-[120px] justify-between items-center">
                            ...
                            <div className=" cursor-pointer"><svg xmlns="http://www.w3.org/2000/svg" width="19" height="17" viewBox="0 0 19 17" fill="none">
                            ...
                            <div className=" cursor-pointer"><svg xmlns="http://www.w3.org/2000/svg" width="11" height="20" viewBox="0 0 11 20" fill="none">
                ...
                <div>
                    <div className=" w-[250px]">
                        <div className=" text-pinnk text-[14px] font-semibold pt-5">Contact Us</div>
                        <div className=" flex mt-5">
                            ...
                            <div className=" ml-5 text-white font-normal text-[12px]">+234 6707653444</div>
                        </div>
                        <div className=" flex mt-5">
                            <div><svg xmlns="http://www.w3.org/2000/svg" width="13" height="15" viewBox="0 0 13 15" fill="none">
                            ...
                            <div className=" ml-5 text-white font-normal text-[12px]">27,Alara Street <br />
                                Yaba 100012 <br />
                                Lagos State
                            </div>
                        </div>
            ...
            <div className=" flex justify-center mt-10 pb-5">
                <span className=" text-white text-[12px] font-normal">All rights reserved. © getlinked Ltd.</span>
            </div>
        </div>
    );
}
